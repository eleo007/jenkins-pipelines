library changelog: false, identifier: 'lib@update_branch', retriever: modernSCM([
    $class: 'GitSCMSource',
...
void runPlaybook(String action_to_test) {
    ...
    sh '''
        git clone --depth 1 -b update_branch_defaults https://github.com/eleo007/package-testing
    '''
